...
class CarCard extends StatelessWidget {
  ...
  child: car.imageUrl != null && car.imageUrl!.isNotEmpty
      ? Image.network(
          ...
          fit: BoxFit.cover,
          errorBuilder: (context, error, stackTrace) => _buildCarImage(car),
        )
      : _buildCarImage(car),
),
                  // سنة الصنع
 ...
 Widget _buildCarImage(Car car) {
  // طباعة المسار في الـ Console للتأكد من الحالة (Capitalization)
  debugPrint("🔍 Looking for brand asset: ${car.localImagePath}"); 
